...
export default function Buconero() {
  return (
    <>
      <section className="border-8 border-[#3b4f6323] m-2 rounded-3xl">
        ...
        <h1 className="flex lg:text-[100px] text-center leading-[50px] lg:leading-[75px] justify-center align-middle my-20 bg-clip-text text-transparent bg-gradient-to-r from-[#121518] via-[#637d97] to-[#ffffff] font-extrabold tracking-tight">
          MODELOS Y DETALLES
        </h1>
      </section>
